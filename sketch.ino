...
const char* default_TOPICO_PUBLISH_2 = "/TEF/lamp001/attrs/heart"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_3 = "/TEF/lamp001/attrs/oxygen";
const char* default_ID_MQTT = "fiware_001"; // ID MQTT
const int default_D4 = 2; // Pino do LED onboard
// Declaração da variável para o prefixo do tópico
const char* topicPrefix = "dreamHeart";
...
void HeartRate() {
  ...
  oxygenLevel = map(oxygenLevel, 0, 1023, 0, 10);  
